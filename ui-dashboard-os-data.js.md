...
useEffect(() => {
const interval = setInterval(() => {
setCpuUsage(Math.floor(Math.random() _ 30) + 30)
setMemoryUsage(Math.floor(Math.random() _ 20) + 60)
setNetworkStatus(Math.floor(Math.random() _ 15) + 80)
setSystemStatus(Math.floor(Math.random() _ 10) + 80)
}, 3000)
...
{/_ Background particle effect _/}
