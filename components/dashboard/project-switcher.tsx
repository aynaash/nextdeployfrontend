      ...
      <PopoverTrigger asChild>
        ...
        >
          <div className='flex items-center space-x-3 pr-2'>
            <div className={cn('size-3 shrink-0 rounded-full', selectedProject.color)} />
...
function ProjectItem({
  ...
  return (
    ...
    >
      ...
      <span className={cn('flex-1 truncate text-sm', isSelected && 'font-medium text-foreground')}>
        {project.title}
      </span>
      {isSelected && <Check size={18} className='absolute right-3 text-foreground' />}
    </Button>
  );
}
