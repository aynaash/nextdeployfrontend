      ...
      <div className='grid gap-8'>
        ...
        <Alert className='!pl-14'>
          ...
          <AlertDescription className='text-balance'>
            SaaS Starter app is running in test mode using Stripe’s sandbox. You can try it out
            using{' '}
            <a
        ...
        <Alert className='border-yellow-400 bg-yellow-50 !pl-14 text-yellow-800'>
          ...
          <AlertDescription className='text-balance'>
            We’re currently finalizing our billing system. Subscriptions will be available shortly.
            Stay tuned!
          </AlertDescription>
        </Alert>
