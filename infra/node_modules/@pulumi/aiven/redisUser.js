 ...
 * ```
 */
class RedisUser extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new RedisUser(name, state, Object.assign(Object.assign({}, opts), { id: id }));
    }
    /**
...
/** @internal */
RedisUser.__pulumiType = 'aiven:index/redisUser:RedisUser';
