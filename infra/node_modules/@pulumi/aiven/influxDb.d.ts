 ...
 * ```
 */
export declare class InfluxDb extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: InfluxDbState, opts?: pulumi.CustomResourceOptions): InfluxDb;
    /**
     * Returns true if the given object is an instance of InfluxDb.  This is designed to work even
     ...
     */
    readonly tags: pulumi.Output<outputs.InfluxDbTag[] | undefined>;
    /**
     ...
     */
    constructor(name: string, args: InfluxDbArgs, opts?: pulumi.CustomResourceOptions);
}
/**
