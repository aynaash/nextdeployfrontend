 ...
 * ```
 */
export declare function getCassandraUser(args: GetCassandraUserArgs, opts?: pulumi.InvokeOptions): Promise<GetCassandraUserResult>;
/**
 ...
 * ```
 */
export declare function getCassandraUserOutput(args: GetCassandraUserOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetCassandraUserResult>;
/**
 * A collection of arguments for invoking getCassandraUser.
 */
