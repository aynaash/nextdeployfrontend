 ...
 * ```
 */
export declare class M3Db extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: M3DbState, opts?: pulumi.CustomResourceOptions): M3Db;
    /**
     * Returns true if the given object is an instance of M3Db.  This is designed to work even
     ...
     */
    readonly tags: pulumi.Output<outputs.M3DbTag[] | undefined>;
    /**
     ...
     */
    constructor(name: string, args: M3DbArgs, opts?: pulumi.CustomResourceOptions);
}
/**
