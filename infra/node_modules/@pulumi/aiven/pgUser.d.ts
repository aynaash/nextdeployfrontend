 ...
 * ```
 */
export declare class PgUser extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: PgUserState, opts?: pulumi.CustomResourceOptions): PgUser;
    /**
     * Returns true if the given object is an instance of PgUser.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is PgUser;
    /**
