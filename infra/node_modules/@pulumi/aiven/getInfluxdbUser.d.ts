 ...
 * ```
 */
export declare function getInfluxdbUser(args: GetInfluxdbUserArgs, opts?: pulumi.InvokeOptions): Promise<GetInfluxdbUserResult>;
/**
 ...
 * ```
 */
export declare function getInfluxdbUserOutput(args: GetInfluxdbUserOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetInfluxdbUserResult>;
/**
 * A collection of arguments for invoking getInfluxdbUser.
 */
