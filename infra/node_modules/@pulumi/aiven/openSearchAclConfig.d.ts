 ...
 * ```
 */
export declare class OpenSearchAclConfig extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: OpenSearchAclConfigState, opts?: pulumi.CustomResourceOptions): OpenSearchAclConfig;
    /**
