 ...
 * ```
 */
export declare class Kafka extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: KafkaState, opts?: pulumi.CustomResourceOptions): Kafka;
    /**
     * Returns true if the given object is an instance of Kafka.  This is designed to work even
     ...
     */
    readonly components: pulumi.Output<outputs.KafkaComponent[]>;
    /**
     ...
     */
    readonly tags: pulumi.Output<outputs.KafkaTag[] | undefined>;
    /**
     ...
     */
    constructor(name: string, args: KafkaArgs, opts?: pulumi.CustomResourceOptions);
}
/**
