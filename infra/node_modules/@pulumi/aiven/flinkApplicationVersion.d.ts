 ...
 * ```
 */
export declare class FlinkApplicationVersion extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: FlinkApplicationVersionState, opts?: pulumi.CustomResourceOptions): FlinkApplicationVersion;
    /**
     * Returns true if the given object is an instance of FlinkApplicationVersion.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is FlinkApplicationVersion;
    /**
     * Application ID
     */
     ...
     */
    readonly applicationVersionId: pulumi.Output<string>;
    /**
