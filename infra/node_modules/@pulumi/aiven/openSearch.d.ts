 ...
 * ```
 */
export declare class OpenSearch extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: OpenSearchState, opts?: pulumi.CustomResourceOptions): OpenSearch;
    /**
