 ...
 * ```
 */
class KafkaConnect extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new KafkaConnect(name, state, Object.assign(Object.assign({}, opts), { id: id }));
    }
    /**
    ...
    constructor(name, argsOrState, opts) {
        ...
        super(KafkaConnect.__pulumiType, name, resourceInputs, opts);
    }
}
exports.KafkaConnect = KafkaConnect;
/** @internal */
KafkaConnect.__pulumiType = 'aiven:index/kafkaConnect:KafkaConnect';
