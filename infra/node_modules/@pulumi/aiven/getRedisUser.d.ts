 ...
 * ```
 */
export declare function getRedisUser(args: GetRedisUserArgs, opts?: pulumi.InvokeOptions): Promise<GetRedisUserResult>;
/**
 ...
 * ```
 */
export declare function getRedisUserOutput(args: GetRedisUserOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetRedisUserResult>;
/**
 * A collection of arguments for invoking getRedisUser.
 */
