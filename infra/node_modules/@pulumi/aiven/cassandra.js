 ...
 * ```
 */
class Cassandra extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new Cassandra(name, state, Object.assign(Object.assign({}, opts), { id: id }));
    }
    /**
...
/** @internal */
Cassandra.__pulumiType = 'aiven:index/cassandra:Cassandra';
