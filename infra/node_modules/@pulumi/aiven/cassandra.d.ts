 ...
 * ```
 */
export declare class Cassandra extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: CassandraState, opts?: pulumi.CustomResourceOptions): Cassandra;
    /**
     * Returns true if the given object is an instance of Cassandra.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is Cassandra;
    /**
     ...
     */
    readonly components: pulumi.Output<outputs.CassandraComponent[]>;
    /**
     ...
     */
    readonly serviceIntegrations: pulumi.Output<outputs.CassandraServiceIntegration[] | undefined>;
    /**
     ...
     */
    readonly tags: pulumi.Output<outputs.CassandraTag[] | undefined>;
    /**
...
export interface CassandraState {
     ...
     * Service integrations to specify when creating a service. Not applied after initial service creation
     */
    serviceIntegrations?: pulumi.Input<pulumi.Input<inputs.CassandraServiceIntegration>[]>;
    /**
     * Specifies the actual name of the service. The name cannot be changed later without destroying and re-creating the service so name should be picked based on intended service usage rather than current attributes.
     */
