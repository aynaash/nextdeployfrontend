 ...
 * ```
 */
export declare class PgDatabase extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: PgDatabaseState, opts?: pulumi.CustomResourceOptions): PgDatabase;
    /**
     * Returns true if the given object is an instance of PgDatabase.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is PgDatabase;
    /**
