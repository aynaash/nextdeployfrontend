...
export declare class Redis extends pulumi.CustomResource {
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: RedisState, opts?: pulumi.CustomResourceOptions): Redis;
    /**
     ...
     */
    readonly components: pulumi.Output<outputs.RedisComponent[]>;
    /**
     ...
     */
    readonly redis: pulumi.Output<outputs.RedisRedi[]>;
    /**
     * Redis user configurable settings
     */
    readonly redisUserConfig: pulumi.Output<outputs.RedisRedisUserConfig | undefined>;
    /**
     ...
     */
    readonly serviceIntegrations: pulumi.Output<outputs.RedisServiceIntegration[] | undefined>;
    /**
     ...
     */
    readonly tags: pulumi.Output<outputs.RedisTag[] | undefined>;
    /**
...
export interface RedisState {
     ...
     * Redis server provided values
     */
    redis?: pulumi.Input<pulumi.Input<inputs.RedisRedi>[]>;
    /**
     * Redis user configurable settings
     */
     ...
     * Service integrations to specify when creating a service. Not applied after initial service creation
     */
    serviceIntegrations?: pulumi.Input<pulumi.Input<inputs.RedisServiceIntegration>[]>;
    /**
     * Specifies the actual name of the service. The name cannot be changed later without destroying and re-creating the
     * service so name should be picked based on intended service usage rather than current attributes.
     */
     ...
     * Tags are key-value pairs that allow you to categorize services.
     */
    tags?: pulumi.Input<pulumi.Input<inputs.RedisTag>[]>;
    /**
     * Prevents the service from being deleted. It is recommended to set this to `true` for all production services to prevent
     * unintentional service deletion. This does not shield against deleting databases or topics but for services with backups
     * much of the content can at least be restored from backup in case accidental deletion is done.
