 ...
 * ```
 */
export declare function getInfluxDb(args: GetInfluxDbArgs, opts?: pulumi.InvokeOptions): Promise<GetInfluxDbResult>;
/**
 ...
 * ```
 */
export declare function getInfluxDbOutput(args: GetInfluxDbOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetInfluxDbResult>;
/**
 * A collection of arguments for invoking getInfluxDb.
 */
