 ...
 * ```
 */
export declare function getFlink(args: GetFlinkArgs, opts?: pulumi.InvokeOptions): Promise<GetFlinkResult>;
/**
 ...
 * ```
 */
export declare function getFlinkOutput(args: GetFlinkOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetFlinkResult>;
/**
 * A collection of arguments for invoking getFlink.
 */
