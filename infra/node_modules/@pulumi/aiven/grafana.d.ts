...
export declare class Grafana extends pulumi.CustomResource {
     ...
     */
    readonly components: pulumi.Output<outputs.GrafanaComponent[]>;
    /**
     ...
     */
    readonly grafanaUserConfig: pulumi.Output<outputs.GrafanaGrafanaUserConfig | undefined>;
    /**
     * Grafana server provided values
     */
    readonly grafanas: pulumi.Output<outputs.GrafanaGrafana[]>;
    /**
     ...
     */
    readonly serviceIntegrations: pulumi.Output<outputs.GrafanaServiceIntegration[] | undefined>;
    /**
     ...
     */
    readonly tags: pulumi.Output<outputs.GrafanaTag[] | undefined>;
    /**
...
export interface GrafanaState {
     ...
     * Service component information objects
     */
    components?: pulumi.Input<pulumi.Input<inputs.GrafanaComponent>[]>;
    /**
     * Service disk space. Possible values depend on the service type, the cloud provider and the project. Therefore, reducing
     * will result in the service rebalancing.
     */
     ...
     * Grafana user configurable settings
     */
    grafanaUserConfig?: pulumi.Input<inputs.GrafanaGrafanaUserConfig>;
    /**
     * Grafana server provided values
     */
    grafanas?: pulumi.Input<pulumi.Input<inputs.GrafanaGrafana>[]>;
    /**
     * Day of week when maintenance operations should be performed. One monday, tuesday, wednesday, etc.
     */
     ...
     * Service integrations to specify when creating a service. Not applied after initial service creation
     */
    serviceIntegrations?: pulumi.Input<pulumi.Input<inputs.GrafanaServiceIntegration>[]>;
    /**
     * Specifies the actual name of the service. The name cannot be changed later without destroying and re-creating the
     * service so name should be picked based on intended service usage rather than current attributes.
     */
