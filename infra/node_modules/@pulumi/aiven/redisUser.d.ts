 ...
 * ```
 */
export declare class RedisUser extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: RedisUserState, opts?: pulumi.CustomResourceOptions): RedisUser;
    /**
     * Returns true if the given object is an instance of RedisUser.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is RedisUser;
    /**
