...
export declare class Pg extends pulumi.CustomResource {
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: PgState, opts?: pulumi.CustomResourceOptions): Pg;
    /**
     ...
     */
    readonly tags: pulumi.Output<outputs.PgTag[] | undefined>;
    /**
