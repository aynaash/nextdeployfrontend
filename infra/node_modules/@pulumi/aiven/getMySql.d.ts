 ...
 * ```
 */
export declare function getMySql(args: GetMySqlArgs, opts?: pulumi.InvokeOptions): Promise<GetMySqlResult>;
/**
 ...
 * ```
 */
export declare function getMySqlOutput(args: GetMySqlOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetMySqlResult>;
/**
 * A collection of arguments for invoking getMySql.
 */
