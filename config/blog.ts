export const BLOG_CATEGORIES: {
...
}[] = [
  {
    title: 'News',
    slug: 'news',
    description: 'The latest updates, features, and announcements from NextDeploy.',
  },
  {
    title: 'Education',
    slug: 'education',
    description: 'Educational articles on deploying and managing Next.js apps with NextDeploy.',
  },
  {
    title: 'Tutorials',
    slug: 'tutorial',
    description: 'Step-by-step guides to help you set up and optimize your deployments.',
  },
  {
    title: 'Case Studies',
    slug: 'case-studies',
    description: 'Real-world examples of how teams are using NextDeploy for scalable deployments.',
  },
];
