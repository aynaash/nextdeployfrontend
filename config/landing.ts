    ...
    list: [
      {
        title: "Collaborative",
        description:
          "Work in sync with your team to deploy updates seamlessly.",
        icon: "laptop",
      },
      {
        title: "Innovative",
        description:
          "Stay ahead with constant updates and cutting-edge deployment features.",
        icon: "settings",
      },
      {
        title: "Scalable",
    ...
    list: [
      {
        title: "Flexible",
        description:
          "Customizable integrations to fit your project's unique needs.",
        icon: "laptop",
      },
      {
        title: "Efficient",
      ...
      },
      {
        title: "Reliable",
        description:
          "Trust our robust infrastructure to keep your deployments running smoothly.",
        icon: "settings",
      },
    ],
  },
